...
namespace BTH_QLDanhSachDeTai_TranMinhTan.Controllers
{
    public class Home2Controller : Controller
    {
        ...
        #endregion
        #region Thêm mới danh sách hướng dẫn đề tài
        ...
        #endregion
        #region Nhập kết quả hướng dẫn đề tài
...
#endregion
        #region In ra màn hình ,  report ko add lên git được nên em xóa rồi
